...
{
	partial class ParameterAskForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Введите значение параметра:";
			// 
			// textBox1
			// 
			...
			this.MaximumSize = new System.Drawing.Size(515, 115);
			this.MinimumSize = new System.Drawing.Size(515, 115);
			this.Name = "ParameterAskForm";
